               ...
               $spaceAddQuery = "INSERT INTO spaces (name, createdTime,ownerId,emailExtension,spaceUrl) 
                 ...
                 if(mysqli_query($con, $spaceAddQuery)){
                   ...
                   $last_created_sapceId =  mysqli_insert_id($con);
                    ...
                    $generalRoomAddQuery = "INSERT INTO category (Name, description,createdBy,type,spaceId) 
                      VALUES('General','A venue where everybody is welcome','$user_last_id','Public','$last_created_sapceId')";

                    $generalRoomAddExec = mysqli_query($con, $generalRoomAddQuery);
                       $last_created_categoryId =  mysqli_insert_id($con);
                   ...
                   if($newUser)
                   {
                     ...
                     // mysqli_query($con, $userAddQuery);
                      ...
                      if(mysqli_query($con, $userUpdQuery))
                      {
                          ...
                          $venuemembers_updQuery = "UPDATE venuemembers SET VenueID='$last_created_categoryId',spaceId='$last_created_sapceId' WHERE id='$venuememeber_last_id' AND UserID='$user_last_id'";
...
<form id="regForm" method="post" action="">
  ...
  <div class="tab">
    ...
    <label class="invalid-lbl" id="invalidLbl-id"style="display: none">Please fill your valid information</label>
  </div>
             ...
             $("#emailExtension").focusin(function(){
              ...
              $('#nextBtn').on('click',function(){
                ...
                var submitBtnTxt = $('#nextBtn').text();
                  ...
                  else if(allDone == false || emailExteValid == false) 
                  {
                     showTab(1);
                     if(allDone && emailExteValid)
                      {
                      ...
                      {
                        swal("Error!", "Please provide valid detail!", "error");
                      }
                  }
...
function validateForm() {
  ...
  document.getElementById("invalidLbl-id").style.display = "block";
