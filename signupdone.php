...
//  	$password = md5($password_1);//encrypt the password before saving in the database
        ...
        // $current_date_time = time();
          ...
          if(!isset($_POST['access'])){
            ...
            echo json_encode(["success"=>$validateRes,"successCode"=>"203"]);die;

          }
          else{
            include('validate.php');
            $validateRes = validateUsers();
           if($validateRes == "202")
           {
               echo json_encode(["success"=>"Your request successfully send","successCode"=>"204"]);die;
            
           }
           else
           {
              echo json_encode(["error"=>"Request already send","successCode"=>"403"]);die;
