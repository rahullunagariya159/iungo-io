			...
			<div class="wrap-login100">
				...
				<?php include('errors.php'); ?>
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="email" name="email" value="<?php echo $email; ?>" placeholder="Use @kellogg.northwestern.edu">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
					...
					if($email)
					{
						if(explode('.',  $_SERVER['HTTP_HOST'])[0]=="kellogg" && substr($email,strpos($email,"@"))!="@kellogg.northwestern.edu")
						{
							?>
							     <!-- Reason -->
