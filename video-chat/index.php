      ...
      {?>
                  <div class="main_container">
                      <div class="team_header d-flex align-items-center justify-content-between">
                        ...
                        <div class="search_button_header d-flex align-items-center">
                          <div class="search_sec position-relative">
                            ...
                            <i class="fa fa-search search-venue"></i>
                      ...
                      ?>
                         ...
                         <div class="live-venue-lst"><label>LIVE VENUES</label></div>
                      ...
                      <div class="main_sec_containers">
                         ...
                         <?php 
                          ...
                          $query1 = "SELECT * FROM category WHERE Name = 'General' AND spaceId='".$spaceId."' AND liveuser > 0 ";
                          $result = mysqli_query($con, $query1);
                          $row=mysqli_fetch_row($result);
                          $genLivCount = mysqli_num_rows($result); 
                        ...
                        if($genLivCount > 0)
                        {
                            ...
                            $user_id = $_SESSION['id'];
                             $memberImgArrGen =  array();
                             $membExploGen = explode(',', $row[6]);

                      foreach ($membExploGen as $membKey => $membValue) {
                             $membImgGetQry = "select profilePicture from accounts where id='$membValue' and profilePicture != '' ";
                          
                            $membImgQryExec = mysqli_query($con,$membImgGetQry);
                            $membImgRes = mysqli_fetch_assoc($membImgQryExec);
                            
                            array_push($memberImgArrGen,$membImgRes['profilePicture']);
                          }
                      ...
                      ?>
                        ...
                        <div class="d-flex flex-column align-items-center content first_cont">
                          ...
                          <?php 
                            $imgMemCount=0;
                            for($i=0;$i<count($memberImgArrGen);$i++)
                            {
                              if($memberImgArrGen[$i] != "" && $imgMemCount < 5)
                              {
                                $imgMemCount = $imgMemCount + 1;
                                 $memProfImg = currentUrl."/video-chat/profileImages/".$memberImgArrGen[$i];
                                echo '<img class="venueMemImg" src="'.$memProfImg.'">';  
                              }
                          ...
                          <div class="and_some_text mt-2 general-content"><?php echo $row[2] ?></div>
                           
                              <div class="and_some_text mt-2"><input type="submit" class="general-btn" value="<?php echo $submit_value; ?>" >
                      ...
                      <?php } ?>
                        ...
                        $query1 = "SELECT * FROM category WHERE Name != 'General' AND spaceId='".$spaceId."' AND liveuser > 0  ORDER BY liveuser DESC";
                        $result = mysqli_query($con, $query1); 
                        $livevenueCount = mysqli_num_rows($result);
                        ...
                        while($row=mysqli_fetch_row($result))
                        {
                          ...
                          foreach ($membExplo as $membKey => $membValue) {
                             $membImgGetQry = "select profilePicture from accounts where id='$membValue' and profilePicture != '' ";
                          
                            $membImgQryExec = mysqli_query($con,$membImgGetQry);
                            $membImgRes = mysqli_fetch_assoc($membImgQryExec);
                            
                            array_push($memberImgArr,$membImgRes['profilePicture']);
                          }
                         ...
                         if($check_venue_member_row){
                            ...
                            $title = '<div class="sort-name custom_again_join">'.$row[1].'</div>';
                            $roomStatus = "";
                    ...
                    ?>
                        ...
                        <?php } else{
                                ...
                                $query = "SELECT * FROM category WHERE Name ='$row[1]' AND spaceId='$spaceId' LIMIT 1";
                                ...
                                $chkOwner = "SELECT * FROM category WHERE Name ='$row[1]' AND createdBy='".$_SESSION['id']."' AND spaceId='$spaceId' "; 
                                $chkOwnerExec = mysqli_query($con,$chkOwner);
                                $countOwrRow=mysqli_num_rows($chkOwnerExec);
                              

                                if (in_array($id,$members, TRUE) || in_array($id,$getModerator, TRUE)  || $countOwrRow > 0)
                                { ?>
                        ...
                        <div class="d-flex flex-column align-items-center content">
                          <?php if($venue_img == "" || $venue_img == null) {
                                  ...
                                  {?>
                                    <div class="profile latter-name" ><?php echo $shortNameVenue; ?></div>
                                    <?php
                        ...
                        <?php echo $title; ?>
                          ...
                          <?php 
                             $imgMemCount=0;
                            for($i=0;$i<count($memberImgArr);$i++)
                            {
                              if($memberImgArr[$i] != "" && $imgMemCount < 5)
                              {
                                  $imgMemCount = $imgMemCount + 1;
                                 $memProfImg = currentUrl."/video-chat/profileImages/".$memberImgArr[$i];
                                echo '<img class="venueMemImg" src="'.$memProfImg.'">';  
                              }
                      ...
                      <?php } 
                        ...
                        else if($livevenueCount < 1 && $genLivCount < 1)
                        {

                          ?><div class="live-venue-notavailable">It seems like you are the only person live right now</div><?php 
                        }
                      ?>
                      </div>
                      <div class="nolive-venue-lst"><label>OTHER VENUES</label></div>
                      ...
                      <div class="main_sec_containers">
                         ...
                         <?php 
                          ...
                          $result = mysqli_query($con, $query1);
                          $row=mysqli_fetch_row($result);
                          $genNotLivCount = mysqli_num_rows($result); 
                      ...
                      <?php } ?>
                        ...
                        $query1 = "SELECT * FROM category WHERE Name != 'General' AND spaceId='".$spaceId."' AND liveuser=0 ORDER BY liveuser DESC";
                        $result = mysqli_query($con, $query1);  
                        $otherVenueCount = mysqli_num_rows($result);
                    ...
                    ?>
                      ...
                      <?php }
                        ...
                        else if($genNotLivCount < 1 && $otherVenueCount < 1)
                        {
                          ?><div class="other-venue-notavailable">Not Available!</div><?php  
                        } ?>
        ...
        <script>
            $(document).ready(function(){
                ...
                $('#myInput').keydown(function() {
                  ...
                  if(this.value != "")
                  {
                    $('.nolive-venue-lst').css("display","none");
                    $('.live-venue-lst').css("display","none");
                    $('.live-venue-notavailable').css("display","none");
                  ...
                  {
                    $('.nolive-venue-lst').css("display","block");
                    $('.live-venue-lst').css("display","block");
                    $('.live-venue-notavailable').css("display","block");
                    console.log("else");
                  }
                ...
                $('#myInput').focusin(function() {
                  console.log("focusin");
                   ...
                   var getTxtVal = $('#myInput').val();
                  // console.log(getTxtVal);
                ...
                $('#myInput').focusout(function() {
                  ...
                  if(getTxtVal != "")
                  {
                    $('.nolive-venue-lst').css("display","none");
                    $('.live-venue-lst').css("display","none");
                    $('.other-venue-notavailable').css("display","none");
                  ...
                  else
                  {
                    $('.nolive-venue-lst').css("display","block");
                    $('.live-venue-lst').css("display","block");
                    $('.other-venue-notavailable').css("display","block");
