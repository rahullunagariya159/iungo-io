...
<div class="user" >
    ...
    <span class="image">
		...
		?>
			...
			<img src="<?php echo $imgpath ?>"  class="userProfImg w3-hover-opacity" onclick="onClick(this)" />
		<?php } else
		{ ?>
			<div class="defaultImgDisplay"></div>	
...
{?>
    ...
    echo "<div><span style='font-weight:700;' class='name redirectTOIndex'>  ".$_SESSION['name']." </span><span class='edit_profile_mn' data-toggle='modal' data-target='#edit_profile'><i class='fa fa-edit'></i></span></div> "; ?>
...
<div class="sidebar_mn">
    ...
    if(isset($_SESSION['id'])){ ?>
    <button type="button" class="create-room btn-create mt-3" data-toggle="modal" data-target="#createNewRoom">Create Room</button>
<?php } 
				...
				<div class="edit_profile_section_mn"> 
					<form action="" name="edit_profile_form" method="POST" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
						...
						<div class="upload-btn-wrapper">
							...
							<div class="btnFile">Upload a file</div>
					  ...
					  <div>
						...
						<input type="submit" class="btn btn-primary editProfile" name="submitProfile" id="submit" value="Submit">
					</form>
				</div>
      			...
      			<div class="col-md-4"> 
      				<div class="profileImg-tag">
	      				...
	      				{ ?>
	      					<button type="button" class="btn btn-danger" id="removeImage" class="remProfImg">Remove Image</button>
	      				<?php } ?>
      				</div>
       			</div>	
