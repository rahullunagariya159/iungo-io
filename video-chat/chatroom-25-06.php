...
{
   $getcategoryQuery = "SELECT * FROM category where id=$category_id";    
...
if(isset($category_id))
{
    $getAllMemberQuery = "SELECT accounts.name,accounts.firstname,venuemembers.*
                          ...
                          WHERE venuemembers.VenueID=$category_id and venuemembers.Role='member' ";    
...
if(isset($_POST['categoryID']))
{
    ...
    $selPendingMemQuery = "SELECT * FROM venuemembers where  UserID=$sessionID and VenueID=$categoryID  and Role='pending'";
...
<?php 
    ...
    //   echo $category;
      ...
      // echo $category;
       ...
       {
         echo "private inn";
          $venuemembers_query = "INSERT INTO venuemembers (UserID, VenueID, DateJoined, LastConnection, TotalConnections, ConnectionTime, Role) VALUES ('$id','$category_id','$current_date_time','$current_date_time',0, '', 'pending')";
       }
       else
       {
          $venuemembers_query = "INSERT INTO venuemembers (UserID, VenueID, DateJoined, LastConnection, TotalConnections, ConnectionTime, Role) VALUES ('$id','$category_id','$current_date_time','$current_date_time',0, '', 'member')";
