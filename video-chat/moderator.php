...
<body>
	 <div class="fluid-container">
       ...
       <div class="row mainrow">
           <div class="col-sm-4 col-xl-3 custom-scrollbar" >
			 ...
			 <div class="col-sm-8 col-12 col-xl-9" id="mylist">	
                  ...
                  <div class="top-moderator-header d-flex align-items-center justify-content-between">
	                ...
	                <div class="search_button_header d-flex align-items-center">
	                  ...
	                  List of request to join the private venue
	                </div>
	              </div>

                  	<!-- <div class="top-moderator-header">
				 		<div class="prev-button">
				 			<a href="index.php" class="backBtn"><i class="fa fa-backward"></i> <span>Back</span></a>
				 		</div>
				 		<div class="venue-request">List of request to join the private venue</div>
			 	  	</div> -->
	                    ...
	                    success:function(data){
		                       console.log(Object.keys(data).length);
		                        ...
		                        {	
                                   ...
                                   console.log("mai in");
                                    $(".pendingUsersList").append('<div class="header-saction mt-5"><div class=" card p-3 mainHeader"><div class="header-moderator"><ul><li>Venue Name : <span>'+roomDetails[key].Name+'</span></li></ul><div class="divder"></div></div>');
