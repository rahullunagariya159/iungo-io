        ...
        <?php
            ...
            while($row=mysqli_fetch_row($result))
            {
              ...
              //echo $venueType; 
                ...
                // $check_venue_member = "SELECT * FROM venuemembers WHERE `UserID` = ".$user_id." AND `VenueID` = '".$category_id."' AND `Role` != 'left' ";  
                $check_venue_member = "SELECT * FROM venuemembers WHERE `UserID` = ".$user_id." AND `VenueID` = '".$category_id."' AND `Role` != 'left' AND `Role` != 'pending' AND `Role` != 'denied' "; 
              ...
              $checkPending_venue_member_row = mysqli_fetch_row($checkPending_venue_member_data);
               ...
               $checkBlockMem = "SELECT * FROM venuemembers WHERE `UserID` = ".$user_id." AND `VenueID` = '".$category_id."'  AND `status` = 'blocked'"; 
